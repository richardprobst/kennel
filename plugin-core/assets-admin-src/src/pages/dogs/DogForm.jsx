...
function DogForm() {
	...
	const fetchDog = async () => {
		...
		try {
			...
			setError(err.message || __('Erro ao carregar cão.', 'canil-core'));
		} finally {
			setLoading(false);
		}
	};
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setError(err.message || __('Erro ao salvar cão.', 'canil-core'));
		} finally {
			setSaving(false);
		}
	};
	...
	return (
		<div className="canil-dog-form">
			<div className="canil-page-header">
				...
				<Button variant="secondary" onClick={() => navigate('/dogs')}>
					...
					<CardBody>
						<div className="canil-form-row">
							...
							<TextControl
								...
								help={__('Ex: Pelo longo, Mini', 'canil-core')}
							/>
						</div>
						<div className="canil-form-row">
							<TextControl
						...
						<div className="canil-form-row">
							<TextControl
								label={__('Data de Nascimento *', 'canil-core')}
								type="date"
